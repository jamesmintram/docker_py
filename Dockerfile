FROM  circleci/clojure:lein-2.9.1-node-browsers

USER root


#REMOVE 3.5
RUN apt-get update && apt-get remove -y python3.5
...
# From: https://github.com/docker-library/python/blob/0581bee3d9811695d854ea0e863781df67fbd390/3.7/stretch/Dockerfile
